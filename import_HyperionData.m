...
m.timestamp = convertTimestamp(h.timestamp) + m.period;
...
m.cri_timestamp = convertTimestamp(h.timestamp) + m.period;
...
m.dtof_timestamp = convertTimestamp(h.timestamp) + m.period;
