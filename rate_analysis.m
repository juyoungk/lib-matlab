function [mean_r, peak_r, peak_t, first_t] = rate_analysis(r, bin_size, varargin)
% input:
...
subplot(2,n_plot,1); imagesc(r); title('PSTH'); 
t_last = n_bin * bin_size * 1000/100; % * 100 ms
xtick_label = 1:t_last;
