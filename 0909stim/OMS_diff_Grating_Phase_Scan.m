...
StimSize_Ct = 800; % um
StimSize_BG = 2.0; % mm
BarWidth = 67; % um; Grating Bar; Half the period; ~RF size of BP
w_Annulus = BarWidth;
%
...
shift_Bg = 0.5; 
shift_speed = 400; % um/s
period_Secs = 1; % secs
  N_periods = 10; % periods of steps
% parameters for recovery stage
period_Secs_recovery = 1; % secs
N_periods_recovery  = 10; % periods of steps
% Angles of gratings
angleCenter = 0; 
%angleBG = 0;
angleBG = [0, 45, 90];
...
try
    ...
    % Texture pointers for Ct and Bg gratings
