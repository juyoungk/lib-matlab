...
%   Saturate high pixels. 
%   Initial sensitivity = 0 and see if there are connected cells due to too much saturation
%
% output:
%    
    %default values
    sensitivity_0 = 0.;
    P_connected_0 = 30; % depending on magnification (zoom) factor
    ...
    function redraw()
        ...
        if FLAG_txt
            ...
            text(ax.XLim(1), ax.YLim(end), str1, 'FontSize', 17, 'Color', 'y', ...
